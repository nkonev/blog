...
public class IndexIT extends AbstractItTestRunner {
    ...
    public void testWebsocketPush() throws Exception {
        ...
        PostDTO postDTO = new PostDTO(0, "Added via websocket", "Пост, пришедший через вебсокет " + new Date(), "image.png", LocalDateTime.now(ZoneOffset.UTC), null, new UserAccountDTO());
