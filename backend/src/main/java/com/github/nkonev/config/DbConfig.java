...
import com.github.nkonev.listener.hibernate.BlogDeleteListener;
import com.github.nkonev.listener.hibernate.BlogInsertListener;
import com.github.nkonev.listener.hibernate.BlogUpdateListener;
...
@Configuration
@EntityScan(basePackages = "com.github.nkonev.entity.jpa")
@EnableJpaRepositories(basePackages = "com.github.nkonev.repo.jpa")
