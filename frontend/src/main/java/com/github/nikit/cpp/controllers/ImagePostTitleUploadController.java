...
public class ImagePostTitleUploadController extends AbstractImageUploadController {
    ...
    public static final String PUT_TEMPLATE = "/api/image/post/title";
    ...
    public HttpHeaders getImage(
        ...
        return super.getImage(
            (Connection conn) -> {
                try (PreparedStatement ps = conn.prepareStatement("SELECT img, content_type FROM images.post_title_image WHERE id = ?");) {
                    ps.setObject(1, id);
